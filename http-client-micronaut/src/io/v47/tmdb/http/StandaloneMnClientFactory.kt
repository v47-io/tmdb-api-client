...
private class StandaloneMnClient(private val rawClient: MnHttpClient, val basePath: String = "") : HttpClient {
    ...
    private fun HttpRequest.toMnHttpRequest(json: Boolean = true): MnHttpRequest<*> {
        ...
        return MnHttpRequest
            .create<Any>(
                when (method) {
                    Get -> MnHttpMethod.GET
                    Post -> MnHttpMethod.POST
                    Put -> MnHttpMethod.PUT
                    Delete -> MnHttpMethod.DELETE
                },
                uriSB.toString()
            )
            .accept(
